...
A89 is **FROZEN at `rebuild@6c28fbc`**. The seedless compatibility and calibration implementation of
§77.3--§77.9 is therefore **AUTHORISED**. This authorisation is instrument-closure work only: it does not
authorise selecting a refinement on measured effects or using development data before the Gate A--E
closure is earned.

Still **NOT AUTHORISED**: choosing a construction on measured effects, $N_{\text{eval}}$,
