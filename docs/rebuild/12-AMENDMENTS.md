...
($\lvert\texttt{phase\_even}\rvert + \lvert\texttt{phase\_odd}\rvert = \lvert U_2\rvert = 5760$ with
...
sensitivity of §77.7. Each of those must be shown able to **fail**: a constant-membership candidate, a
