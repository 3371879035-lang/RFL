...
**Gate A -- aggregate reference calibration.** The measured side must equal the predicted functional,
...
rather than a relocated fixture or a narrowed domain.
